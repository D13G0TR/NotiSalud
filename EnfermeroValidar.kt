...
class EnfermeroValidarActivity : ComponentActivity() {
...
@Composable
fun EnfermeroValidarScreen(modifier: Modifier = Modifier) {
    Column(
...
@Composable
fun EnfermeroValidarScreenPreview() {
    NotiSaludmainTheme {
        EnfermeroValidarScreen()
    }
}